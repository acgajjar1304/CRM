...
<div class="container">
  <div class="row login-container column-seperation">  
        <div class="col-md-5 col-md-offset-1">
          ...
          <p>
            <a href="registration.php">Sign up Now!</a> for a AS international account,It's free and always will be..</p>
          <br>

		   
        </div>
        <div class="col-md-5 "> <br>
        <p style="color:#F00; font-size:12px;"><?php echo $_SESSION['msg']=""; ?></p>
